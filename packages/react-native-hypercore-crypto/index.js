...
exports.keyPair = async function (seed) {
...
exports.sign = async function (message, secretKey) {
  var signature = bufferAlloc(sodium.crypto_sign_BYTES)
  sodium.crypto_sign_detached(signature, message, secretKey)
  return signature
}

exports.verify = async function (message, signature, publicKey) {
  return sodium.crypto_sign_verify_detached(signature, message, publicKey)
}

exports.data = async function (data) {
  return blake2b([
    LEAF_TYPE,
...
exports.leaf = async function (leaf) {
  return exports.data(leaf.data)
}

exports.parent = async function (a, b) {
  if (a.index > b.index) {
    var tmp = a
    a = b
    b = tmp
...
exports.tree = async function (roots) {
...
exports.randomBytes = async function (n) {
  var buf = bufferAlloc(n)
  sodium.randombytes_buf(buf)
  return buf
}

exports.discoveryKey = async function (tree) {
...
async function blake2b (buffers) {
  var digest = bufferAlloc(32)
